...
public class ApplicationFileLocator {
    ...
    public ApplicationFileLocator(byte[] data){
        if(data.length % 4 != 0) throw new EMVException("Length is not a multiple of 4. Length="+data.length);
    ...
    public void dump(PrintWriter pw, int indent){
        pw.println(Util.getEmptyString(indent)+"Application File Locator");
